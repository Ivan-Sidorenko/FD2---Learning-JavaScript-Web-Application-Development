"use strict";
    ...
    function squareRoots(a,b,c) {
      if ( a===0) // при a равном 0 получаем линейное уравнение  
            return [-c/b]; // в матиматике деление на ноль невозмoжно (все превращается в "0"), а JS деление на "0" дает Infinity
